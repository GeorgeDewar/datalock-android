...
//                final String ModelNumberStringUUID="00002a24-0000-1000-8000-00805f9b34fb";
...
//                            Log.d(TAG, "got write characteristic: " + writeCharacteristic.getUuid().toString());
//                        }
//                    }
//                }
...
//
//                    boolean setValueSuccess = writeCharacteristic.setValue(strBytes);
//                    if (setValueSuccess) Log.d(TAG, "setSuccess : " + setValueSuccess); else Log.d(TAG, "set fail");
//
//                    byte[] bytes = writeCharacteristic.getValue();
//                    Log.d(TAG, "bytes: " + bytes.toString());
//
////                    writeCharacteristic(characteristic);
//                    final BluetoothGattCharacteristic fWriteCharacteristic = writeCharacteristic;
//
//
//
//                }
...
//                            Log.d(TAG, "write property discovered");
//                            // writing characteristic functions
//                            String str = "hi";
//                            byte[] strBytes = str.getBytes();
//
//                            boolean setValueSuccess = characteristic.setValue(strBytes);
//                            if (setValueSuccess) Log.d(TAG, "setSuccess : " + setValueSuccess); else Log.d(TAG, "set fail");
//
...
////                            if (writeSuccess) Log.d(TAG, "writeSuccess : " + writeSuccess); else Log.d(TAG, "write fail");
//                        }
//                    }
//
//                }
        ...
        public void onCharacteristicWrite(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic, int status)
        {
            ...
            Log.d(TAG, "characteristic string value: " + characteristic.getStringValue(0));
